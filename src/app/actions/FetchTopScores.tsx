...
export const useFetchBraA1TopScores = () => {
  ...
  const fetchData = useCallback(async () => {
    const url =
      "https://api-football-beta.p.rapidapi.com/players/topscorers?season=2023&league=71";
    ...
    try {
      ...
      if (!response.ok) {
        const errorMessage =
          response.status === 401
            ? "Unauthorized: Check if the API key is correct."
            : response.status === 429
            ? "Too Many Requests: You have hit the rate limit. Please try again later."
...
export const useFetchPremierTopScores = () => {
  ...
  const fetchData = useCallback(async () => {
    const url =
      "https://api-football-beta.p.rapidapi.com/players/topscorers?season=2023&league=39";
    const API_KEY = process.env.NEXT_PUBLIC_FOOTBALL_API;
    if (!API_KEY) {
      console.error("API key is not defined");
      setError("API key is not defined");
...
export const useFetchChampionsTopScores = () => {
  ...
  const fetchData = useCallback(async () => {
    const url =
      "https://api-football-beta.p.rapidapi.com/players/topscorers?season=2023&league=2";
    const API_KEY = process.env.NEXT_PUBLIC_FOOTBALL_API;
    if (!API_KEY) {
      console.error("API key is not defined");
      setError("API key is not defined");
...
export const useFetchLibertadoresTopScores = () => {
  ...
  const fetchData = useCallback(async () => {
    const url =
      "https://api-football-beta.p.rapidapi.com/players/topscorers?season=2023&league=13";
