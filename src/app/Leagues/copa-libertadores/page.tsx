...
import { useFetchNewsDataLibertadores } from "../../actions/FetchDataLeagues";
import { useFetchLibertadoresTopScores } from "../../actions/FetchTopScores";
...
export default function Libertadores() {
  ...
  const { data2, error2 } = useFetchNewsDataLibertadores();
  const { data3, error3 } = useFetchLibertadoresTopScores();
  console.log(data3);
  if (error)
